...
var testGVK = schema.GroupVersionKind{Group: "", Version: "v1", Kind: "ConfigMap"}
...
func (p *plainExtractor) ExpectedInputType() reflect.Type                          { return nil }
func (p *plainExtractor) Extract(_ context.Context, _ any, _ fwkdl.Endpoint) error { return nil }
...
func TestCollectIsNoop(t *testing.T) {
	src := NewK8sNotificationSource(NotificationSourceType, "test", testGVK)
	err := src.Collect(context.Background(), nil)
