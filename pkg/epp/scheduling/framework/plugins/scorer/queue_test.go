...
func TestQueueScorer(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			pods: []types.Pod{
				&types.PodMetrics{PodInfo: &dltypes.PodInfo{}, MetricsState: &backendmetrics.MetricsState{WaitingQueueSize: 10}},
				&types.PodMetrics{PodInfo: &dltypes.PodInfo{}, MetricsState: &backendmetrics.MetricsState{WaitingQueueSize: 5}},
				&types.PodMetrics{PodInfo: &dltypes.PodInfo{}, MetricsState: &backendmetrics.MetricsState{WaitingQueueSize: 0}},
			},
