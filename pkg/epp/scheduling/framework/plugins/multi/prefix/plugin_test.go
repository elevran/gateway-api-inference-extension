...
func TestPrefixPlugin(t *testing.T) {
	...
	pod1 := &types.PodMetrics{PodInfo: &k8s.PodInfo{NamespacedName: k8stypes.NamespacedName{Name: "pod1"}}}
	pod2 := &types.PodMetrics{PodInfo: &k8s.PodInfo{NamespacedName: k8stypes.NamespacedName{Name: "pod2"}}}
