...
func TestSchedulePlugins(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			input: []backendmetrics.PodMetrics{
				&backendmetrics.FakePodMetrics{Pod: &dltypes.PodInfo{NamespacedName: k8stypes.NamespacedName{Name: "pod1"}}},
				&backendmetrics.FakePodMetrics{Pod: &dltypes.PodInfo{NamespacedName: k8stypes.NamespacedName{Name: "pod2"}}},
				&backendmetrics.FakePodMetrics{Pod: &dltypes.PodInfo{NamespacedName: k8stypes.NamespacedName{Name: "pod3"}}},
			},
