...
func TestDirector_HandleResponse(t *testing.T) {
	...
	reqCtx := &handlers.RequestContext{
		...
		TargetPod: &k8s.PodInfo{NamespacedName: types.NamespacedName{Namespace: "namespace1", Name: "test-pod-name"}},
	}
...
func (p *testPostResponse) PostResponse(_ context.Context, _ *schedulingtypes.LLMRequest, response *Response, targetPod *k8s.PodInfo) {
